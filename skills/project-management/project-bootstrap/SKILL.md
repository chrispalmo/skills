...
description: >-
  ...
  IMPLEMENTATION_STATUS, AGENTS.md, cursor rules) on new or under-documented
  repos. Detects project type (greenfield, consulting, container, meta, minimal).
  Use when starting a new project, retrofitting PM docs, or when the user asks
  to bootstrap, scaffold, or set up project management files.
---
