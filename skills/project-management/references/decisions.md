...
| D-004 | 2026-07-09 | ~~AGENTS.md + `.cursor/rules/` for agent handoff enforcement~~ superseded by D-011 |
...
| D-011 | 2026-08-06 | Keep shared startup + handoff guidance in `AGENTS.md`; add a one-line `CLAUDE.md` import shim because Claude Code does not load `AGENTS.md` natively; do not duplicate shared guidance in vendor rule trees |
